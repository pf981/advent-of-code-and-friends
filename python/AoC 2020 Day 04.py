...
# MAGIC <ul>
# MAGIC <li><code>byr</code> (Birth Year)</li>
# MAGIC <li><code>iyr</code> (Issue Year)</li>
# MAGIC <li><code>eyr</code> (Expiration Year)</li>
# MAGIC <li><code>hgt</code> (Height)</li>
# MAGIC <li><code>hcl</code> (Hair Color)</li>
# MAGIC <li><code>ecl</code> (Eye Color)</li>
# MAGIC <li><code>pid</code> (Passport ID)</li>
# MAGIC <li><code>cid</code> (Country ID)</li>
# MAGIC </ul>
# MAGIC <p>Passport data is validated in batch files (your puzzle input). Each passport is represented as a sequence of <code>key:value</code> pairs separated by spaces or newlines. Passports are separated by blank lines.</p>
# MAGIC <p>Here is an example batch file containing four passports:</p>
# MAGIC <pre><code>ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
# MAGIC byr:1937 iyr:2017 cid:147 hgt:183cm
# MAGIC 
# MAGIC iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884
# MAGIC hcl:#cfa07d byr:1929
# MAGIC 
# MAGIC hcl:#ae17e1 iyr:2013
# MAGIC eyr:2024
# MAGIC ecl:brn pid:760753108 byr:1931
# MAGIC hgt:179cm
# MAGIC 
# MAGIC hcl:#cfa07d eyr:2025 pid:166559648
# MAGIC iyr:2011 ecl:brn hgt:59in
# MAGIC </code></pre>
# MAGIC <p>The first passport is <em>valid</em> - all eight fields are present. The second passport is <em>invalid</em> - it is missing <code>hgt</code> (the Height field).</p>
# MAGIC <p>The third passport is interesting; the <em>only missing field</em> is <code>cid</code>, so it looks like data from North Pole Credentials, not a passport at all! Surely, nobody would mind if you made the system temporarily ignore missing <code>cid</code> fields.  Treat this "passport" as <em>valid</em>.</p>
# MAGIC <p>The fourth passport is missing two fields, <code>cid</code> and <code>byr</code>. Missing <code>cid</code> is fine, but missing any other field is not, so this passport is <em>invalid</em>.</p>
...
inp = '''eyr:2029 byr:1931 hcl:z cid:128
