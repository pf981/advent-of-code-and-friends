...
o.minimize(int(1e13)*d14+int(1e12)*d13+int(1e11)*d12+int(1e10)*d11+int(1e9)*d10+int(1e8)*d9+int(1e7)*d8+int(1e6)*d7+int(1e5)*d6+int(1e4)*d5+int(1e3)*d4+int(1e2)*d3+int(1e1)*d2+int(1e0)*d1)
